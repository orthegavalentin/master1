...
to flock  ;; turtle procedure
  ...
  if any? flockmates
    [find-nearest-neighbor
      let as multiplyScalarvect separate-coeff vectFromAngle (first avoidance-direction) (first but-first avoidance-direction)
...
to-report avoidance-direction
  ...
  [report list (towards nearest-neighbor + 180) (1 / (distance nearest-neighbor))]
  [report list 0 0]
end
